...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if ((lib.uniffi_matrix_sdk_checksum_method_oauthauthorizationdata_login_url() and 0xFFFF) != 7277) {
...
public object FfiConverterTypeEncryptionSystem : FfiConverterRustBuffer<EncryptionSystem>{
    ...
    override fun allocationSize(value: EncryptionSystem): ULong = when(value) {
...
public object FfiConverterTypePaginationStatus : FfiConverterRustBuffer<PaginationStatus>{
    ...
    override fun allocationSize(value: PaginationStatus): ULong = when(value) {
